...
public class HuffmanTree {
	...
	*/
	...
	public void setBinaryString(CharacterNode focusNode,String tempNBinaryString){
		focusNode.setCode(tempNBinaryString);
		if(focusNode.getOrginalCharSymbol() !='|'){
			compressFileSize += focusNode.getNoChars()*tempNBinaryString.length();
		}
		if(focusNode.getLeftChild() != null){
			setBinaryString(focusNode.getLeftChild(), tempNBinaryString+"0");
		}
		if(focusNode.getRightChild() != null){
			setBinaryString(focusNode.getRightChild(),tempNBinaryString+"1");
		}
	}
